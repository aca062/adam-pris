...
<body>
	...
	<main role="main" style="min-height: 67vh;">
		...
		<section class="text-center"
			...
			<form id="crearCliente-form"
				action="ServletCliente?action=crear_cliente" method="post"
				role="form">
				<div class=row style="text-align: center">
					...
					<div class=col-sm-4 style="margin: 0px auto">
						<input type="number" min="0" step="1" pattern="\d*" name="peso"
							id="peso" tabindex="2" class="form-control" placeholder="Peso"
				...
				<div class=row style="text-align: center; margin-top: 2%">
					<div class=col-sm-4 style="margin: 0px auto">
						<input type="submit" name="register-client" id="register-client"
							tabindex="4" class="btn btn-dark" value="Crear cliente"
