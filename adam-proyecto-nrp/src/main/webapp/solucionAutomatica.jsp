...
<html lang="es"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>Solución automática</title>
  ...
  <body>
    ...
    <main role="main">
     ...
     <h2><b>Solución automática</b></h2>
     <h4 style="margin-top: 2%">Escoja el esfuerzo máximo del equipo</h4>
     <div class = row style = "text-align: center">
     <div class = col-sm-4 style = "margin: 0px auto">
     <input type="text" name="esfuerzo" id="esfuerzo" tabindex="1" class="form-control" placeholder="Esfuerzo" value="" style = "border-radius: 2rem">
     </div>
     </div>
     <div class = row style = "text-align: center; margin-top: 2%">
     	<div class = col-sm-4 style = "margin: 0px auto">
     		<button class="btn btn-default btn-dark" type="button" style = "border-radius: 2rem; margin-right:2%"><span class="glyphicon glyphicon-step-backward"></span>&nbsp;Ejecutar </button>
     	</div>
     </div>
     <div class = row style = "text-align: left; margin-left: 8%">
     	<h2><b>Solución óptima:</b></h2>
     </div>
      </section>
