  ...
  <body>
    ...
    <main role="main">
     ...
     <input type="text" name="esfuerzo" id="esfuerzo" tabindex="1" class="form-control" placeholder="Esfuerzo" value="" style = "border-radius: 2rem">
     	...
     	<h2><b>Esfuerzo actual X / EsfuerzoMax</b></h2>
     	<div class = row style = "text-align: center; margin-top: 2%">
     	<div class = col-sm-4 style = "margin: 0px auto">
     		<button class="btn btn-default btn-dark" type="button" style = "border-radius: 2rem; margin-right:2%"><span class="glyphicon glyphicon-step-backward"></span>&nbsp;Calcular métricas </button>
     	</div>
     </div>
      </section>
