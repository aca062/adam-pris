...
<html lang="es"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <body>
    ...
    <main role="main">
     ...
     <div class = col-sm-4 style = "margin: 0px auto">
     <input type="text" name="esfuerzo" id="esfuerzo" tabindex="2" class="form-control" placeholder="Esfuerzo" value="" style = "border-radius: 2rem">
     </div>
     </div>
     
     <div class="container-xl">
    <div class="table" style="max-width:65%; margin-left:8%;  margin-top:5%">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6" style= "text-align:left"><h3>Valor de los clientes</h3></div>
                </div>
            </div>
